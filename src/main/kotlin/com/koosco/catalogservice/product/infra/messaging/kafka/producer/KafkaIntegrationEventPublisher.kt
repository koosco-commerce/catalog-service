...
import com.koosco.catalogservice.product.infra.messaging.kafka.ProductIntegrationTopicResolver
...
class KafkaIntegrationEventPublisher(
    private val topicResolver: ProductIntegrationTopicResolver,
